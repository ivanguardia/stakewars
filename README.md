...
## Description
I have carried out the project following the guide:  
...
### 2.4 Init NEAR directories & replace *config.json*
...
### 2.5 Generate validator_key.json
...
> "secret_key":"ed25519:3btWQ2ALPgNaWn4D7xGQBy3tCqqJS2b7f65ZfkZna7bERThzXMzmV1P4hmuW53qBSea6NBQjtFdzX2hDckctZPE5"
> }

### 2.6 Activating the account
	near login
...
> jul 22 20:58:50 usuario neard[5184]: 2022-07-22T12:48:50.235239Z  INFO neard: version="trunk" build="crates-0.14.0-234-g0f81dca95" latest_protocol=100
...
### 3.1 Deploy a Staking Pool Contract
...
### 3.4 Check proposal for next epoch
...
### 6.2 Create cron
	...
	*/5 * * * * sh /home/usuario/scripts/ping.sh
